...
// vfscommon.RemoteObject interface instead of rclone's fs.Object.
...
func New(ctx context.Context, o vfscommon.RemoteObject, initialChunkSize int64, maxChunkSize int64, streams int) ChunkedReader {
