...
func (s *stream) readFrom(ctx context.Context) {
	...
	rc, err := s.cr.o.Open(ctx, &types.RangeOption{Start: s.offset, End: s.offset + s.size - 1})
	if err != nil {
...
func newParallel(ctx context.Context, o types.RemoteObject, chunkSize int64, streams int) ChunkedReader {
