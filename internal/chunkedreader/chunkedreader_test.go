...
// testRemote implements types.RemoteObject backed by a byte slice
...
func (r *testRemote) Open(ctx context.Context, options ...types.OpenOption) (io.ReadCloser, error) {
